...
|<div style="width:600px">Training and validation data</div>||
|---|---|
...
The ICBHI and the Steth dataset include a total of 238 participants (37% girls/women) from the infancy up to >90 years of age. 177 participants suffered from respiratory diseases, which were chronic in 124 cases, predominately COPD (75 cases) and asthma (34 cases). The participants provided 25618 seconds of respiratory auscultation, namely 2570 seconds by the healthy and 23048 seconds by the respiratory ill. The duration of the respiratory cycles was - on the average of the participant averages of the ICBHI set - 2.4 in the healthy and 2.2 in the acutely ill versus 3.0 in the chronically ill.
## Programming
...
- slicing to eight-second audio chunks with 90% overlap for sounds from healthy and 10% for such from respiratory ill persons (i.e. healthy data is augmented more to increase its proportion to nearly 50%)
...
- during the return state:
  ...
  - a threshold below which consulting a physician is recommended (traffic light system)
...
This is all. The function to store it will be implemented later.
